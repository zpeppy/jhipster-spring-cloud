...
class MicroserviceKafkaResourceIT {
    ...
    //     restMockMvc.perform(post("/api/microservice-kafka/publish/topic-produce?message=value-produce"))
    ...
    //
    //     MvcResult mvcResult = restMockMvc.perform(get("/api/microservice-kafka/consume?topic=topic-consume"))
    //         .andExpect(status().isOk())
